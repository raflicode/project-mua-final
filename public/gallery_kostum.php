...
<div class="container py-2" style="max-width: 430px;">
    ...
    <div class="hero-card mt-2">
        <img src="../assets/fotokostum1.jpeg.jpeg" alt="Kostum Wedding">
    ...
    <!-- Gallery -->
    <section class="mt-5">
        <h4 class="section-title">Galerry Kostum</h4>
        ...
        <div class="row g-3">
            ...
            <div class="col-4">
                <div class="gallery-card">
                    <img src="../assets/fotokostum1.jpeg.jpeg" class="gallery-img" alt="Kostum">

                    <h6 class="blog-title">Blog Posts</h6>
                    <p class="blog-desc">
                        Menawarkan kostum adat yang elegan.
                    </p>
                </div>
            </div>
            ...
            <div class="col-4">
                <div class="gallery-card">
                    <img src="../assets/fotokostum2.jpeg.jpg" class="gallery-img" alt="Kostum">
            ...
            <div class="col-4">
                <div class="gallery-card">
                    <img src="../assets/fotokostum3.jpeg.jpg" class="gallery-img" alt="Kostum">
            ...
            <div class="col-4">
                <div class="gallery-card">
                    <img src="../assets/fotokostum4.jpeg.jpg" class="gallery-img" alt="Kostum">
            ...
            <div class="col-4">
                <div class="gallery-card">
                    <img src="../assets/fotokostum5.jpeg.jpeg" class="gallery-img" alt="Kostum">
            ...
            <div class="col-4">
                <div class="gallery-card">
                    <img src="../assets/fotokostum6.jpeg.png" class="gallery-img" alt="Kostum">
            ...
            <div class="col-4">
                <div class="gallery-card">
                    <img src="../assets/fotokostum7.jpeg.png" class="gallery-img" alt="Kostum">
            ...
            <div class="col-4">
                <div class="gallery-card">
                    <img src="../assets/fotokostum8.jpeg.png" class="gallery-img" alt="Kostum">
