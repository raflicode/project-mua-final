...
// Check for errors from proses_isidata
...
<head>
    ...
    <title>Isi Data Diri - Yayuk Makeover</title>
...
<div class="container my-4 wrapper">
    ...
    <!-- Form Utama -->
    <form action="../actions/proses_isidata.php<?= $fromPage ? '?from=' . urlencode($fromPage) : '' ?>" method="post">
        <div class="row g-4">
