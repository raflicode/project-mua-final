        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-7">
                ...
                <p>Kami memahami bahwa pernikahan adalah momen sekali seumur hidup yang penuh dengan detail dan harapan.
                    Itulah mengapa kami menganggap setiap klien sebagai mitra dalam berkarya.</p>
                <p>Melalui diskusi yang mendalam dan sentuhan profesional, kita akan merajut sebuah kisah kecantikan
            ...
            <div class="col-md-4">
                <div class="card gallery-card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <a href="public/gallery_makeup.php" class="btn btn-outline-secondary btn-sm rounded-pill px-4">
    LIHAT
</a>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card gallery-card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <a href="public/gallery_dekor.php" class="btn btn-outline-secondary btn-sm rounded-pill px-4">
    LIHAT
</a>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card gallery-card shadow-sm">
                    ...
                    <div class="card-body">
                       ...
                       <a href="public/gallery_kostum.php" class="btn btn-outline-secondary btn-sm rounded-pill px-4">
    LIHAT
</a>
                    </div>
                </div>
